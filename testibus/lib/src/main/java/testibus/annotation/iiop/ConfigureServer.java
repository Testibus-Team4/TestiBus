...
import testibus.annotation.ConfigurePartRunner;
import testibus.annotation.logging.LoggingExtension;
import testibus.util.Assertions;
...
import static testibus.annotation.iiop.ConfigureServer.Separation.INTER_ORB;
import static testibus.annotation.iiop.ConfigureServer.ServerName.DEFAULT_SERVER;
import static testibus.annotation.iiop.OrbSteward.getActivatedRootPoa;
...
class ServerExtension implements
    ...
    public void beforeAll(ExtensionContext ctx) {
        ...
        if (AnnotationSupport.findAnnotation(ctx.getRequiredTestClass(), ConfigureOrb.class).isPresent()
                || AnnotationSupport.findAnnotation(ctx.getElement(), ConfigureOrb.class).isPresent())
            Assertions.fail(String.format("Use of @%s and @%s on the same test is unsupported.",
