 ...
 */
package testibus.annotation.logging;
...
import static testibus.util.Queues.drain;
import static testibus.util.Queues.drainInOrder;
...
public class TestLogger {
    ...
    public void before(ExtensionContext ctx) {
        List<LogSetting> settings = AnnotationSupport.findRepeatableAnnotations(ctx.getElement(), Logging.class)
                        .stream()
                        .map(LogSetting::new)
