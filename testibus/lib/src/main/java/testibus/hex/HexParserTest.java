...
import static testibus.hex.HexParser.HEX_DUMP;
import static testibus.hex.HexParser.HEX_STRING;
import static testibus.matchers.ByteArrayMatchers.emptyByteArray;
import static testibus.matchers.ByteArrayMatchers.matchesHex;
...
class HexParserTest {
    ...
    void testHexDumpAlmostCommentLine() {
        // lines starting with two dashes are ignored
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_DUMP.parse("--\n-"));
    }

    @Test
    void testHexDumpInvalidHexLine() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_DUMP.parse("47494f5O 01020000 0000016c 00000007  \"GIOP.......l....\""));
    }

    @Test
    void testHexDumpInvalidAsciiLine() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_DUMP.parse("47494f50 01020000 0000016c 00000007  \"FIOP.......l....\""));
    }
    ...
    void testHexString1Char() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_STRING.parse("0"));
    }

    @Test
    void testHexString3Chars() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_STRING.parse("000"));
    }

    @Test
    void testHexStringBadChars() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> HEX_STRING.parse("gg"));
    }
